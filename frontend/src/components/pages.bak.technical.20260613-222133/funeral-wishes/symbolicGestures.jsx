...
export const questions = [
  ...
  { id: "butterfly_release", label: "Butterfly release", type: "yesno", category: "documents" },
  ...
  { id: "biodegradable_balloons", label: "Biodegradable balloons", type: "yesno", category: "documents" },
  { id: "plant_tree", label: "Plant a tree", type: "yesno", category: "documents" }
];
