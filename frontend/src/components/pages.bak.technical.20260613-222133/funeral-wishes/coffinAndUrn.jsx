...
export const questions = [
  ...
  { id: "coffin_type_pefc", label: "PEFC-certified solid wood", type: "yesno", showIf: chooseDetails, category: "documents" },
  { id: "coffin_type_mdf", label: "Simple coffin (MDF)", type: "yesno", showIf: chooseDetails, category: "documents" },
  ...
  { id: "urn_pefc", label: "PEFC-certified solid wood urn", type: "yesno", showIf: [chooseDetails, chooseUrn], category: "documents" },
  { id: "urn_biodegradable", label: "Biodegradable urn", type: "yesno", showIf: [chooseDetails, chooseUrn], category: "documents" },
  { id: "urn_porcelain_ceramic", label: "Porcelain / ceramic urn", type: "yesno", showIf: [chooseDetails, chooseUrn], category: "documents" },
  { id: "urn_metallic", label: "Metal urn", type: "yesno", showIf: [chooseDetails, chooseUrn], category: "documents" },
