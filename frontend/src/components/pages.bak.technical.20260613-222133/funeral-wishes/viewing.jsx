...
export const questions = [
  ...
  { id: "viewing_at_home", label: "At home, private address:", showIf: canVisit, category: "documents" },
  { id: "viewing_place_of_residence", label: "Where I will be living, if the place allows it, residence or clinic:", showIf: canVisit, category: "documents" },
  { id: "viewing_ag_funeral_funeral_home", label: "In one of A&G Funeral's funeral homes:", showIf: canVisit, category: "documents" },
