...
function getQuestionCategory(question) {
  return question.category === "documents" ? "documents" : "easy";
}
...
export default function QuestionPage({
  ...
  const documentQuestions = visibleQuestions.filter(
    (question) => getQuestionCategory(question) === "documents"
  );
  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.categoryBox}>
        <h2 style={styles.categoryTitle}>You might need documents</h2>
        <p style={styles.categoryHint}>
          These questions may require official records, contracts, references, photos, or external confirmation.
        </p>

        {documentQuestions.length === 0 ? (
          <p>No document-related questions visible yet.</p>
        ) : (
          documentQuestions.map(renderQuestion)
        )}
      </section>
