...
const wantsFlowers = { id: "personalized_floral_compositions", equals: "yes", category: "easy" };
...
export const questions = [
  ...
  { id: "composition_types", label: "Type of arrangement: coffin spray, bouquet, cushion, wreath, floral decoration for the ceremony location, other, etc.", type: "textarea", showIf: wantsFlowers, category: "technical" },
