...
export const questions = [
  ...
  { id: "hearse", label: "Hearse", type: "yesno", showIf: chooseVehicle, category: "technical" },
  { id: "funeral_van", label: "Funeral van", type: "yesno", showIf: chooseVehicle, category: "technical" },
