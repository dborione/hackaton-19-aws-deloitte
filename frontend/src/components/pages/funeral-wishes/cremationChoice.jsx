...
export const questions = [
  ...
  { id: "columbarium_cemetery", label: "Columbarium at the cemetery of:", showIf: { id: "urn_burial", equals: "yes" }, category: "technical" },
  { id: "urn_field_cemetery", label: "Urn field at the cemetery of:", showIf: { id: "urn_burial", equals: "yes" }, category: "technical" },
  { id: "concession_vault_cemetery", label: "Concession / vault at the cemetery of:", showIf: { id: "urn_burial", equals: "yes" }, category: "technical" },
  { id: "concession_number", label: "Concession number:", showIf: { id: "urn_burial", equals: "yes" }, category: "technical" },
  ...
  { id: "crematorium_scattering_lawn", label: "Scattering lawn at the crematorium", type: "yesno", showIf: { id: "ashes_scattering", equals: "yes" }, category: "technical" },
  { id: "cemetery_scattering_lawn", label: "Scattering lawn at the cemetery of:", showIf: { id: "ashes_scattering", equals: "yes" }, category: "technical" },
  { id: "sea_scattering_by_family", label: "Scattering by the family at sea from:", showIf: { id: "ashes_scattering", equals: "yes" }, category: "technical" },
