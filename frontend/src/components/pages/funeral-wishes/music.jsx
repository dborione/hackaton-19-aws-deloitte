...
const chooseMusic = [
  { id: "no_music", equals: "no", category: "easy" },
  { id: "relatives_choose_music", equals: "no", category: "easy" }
];

export const questions = [
  { id: "no_music", label: "I would prefer there to be no music", type: "yesno", category: "easy" },
  { id: "relatives_choose_music", label: "I let my relatives choose", type: "yesno", showIf: { id: "no_music", equals: "no", category: "easy" }, category: "easy" },
